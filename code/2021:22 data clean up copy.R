...
HR_url1 <- "https://www.hockey-reference.com/leagues/NHL_2022_skaters.html#header"
HR_url2 <- "https://www.hockey-reference.com/awards/voting-2022.html#all-hart-stats"
HR_url3 <- "https://www.hockey-reference.com/leagues/NHL_2022_skaters-misc.html"
...
library("writexl")
write_xlsx(HR_data2,"/Users/mirandawallace/Desktop/4th YEAR/STATS 445/S445 RMarkdown//HR_data_21.22.xlsx")


library(readxl)
hr.xl <- read_excel("HR_data_21.22.xlsx")
View(hr.xl)

hr.fil <- filter(hr.xl, GP >= 50 & (TOI/GP) >= 15)
write_xlsx(hr.fil,"/Users/mirandawallace/Desktop/4th YEAR/STATS 445/S445 RMarkdown//S445_finalProject_filteredData.xlsx")

hr.final <- read_excel("S445_finalProject_filteredData.xlsx")
View(hr.final)
